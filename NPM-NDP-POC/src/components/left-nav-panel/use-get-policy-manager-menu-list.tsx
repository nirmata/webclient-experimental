...
export const useGetPolicyManagerMenuList = (featuresList: string[], userRole: string): TMenuItem[] => {
  return [
    {
    ...
    {
      id: 'policies_menu',
      route: userRole === 'devops' ? 'webclient/#clustersPolicyReport' : 'webclient/#clustersPolicyReport',
      title: 'Policies',
      dataTestId: 'policy',
