...
.n-m-b-2,.n-m-b-sm { margin-bottom: ${props => props.variables['spacing.2']}; }
...
.n-m-b-6,.n-m-b-lg { margin-bottom: ${props => props.variables['spacing.6']}; }
...
.n-p-r-2,.n-p-r-sm { padding-right: ${props => props.variables['spacing.2']}; }
.n-p-t-2,.n-p-t-sm { padding-top: ${props => props.variables['spacing.2']}; }
.n-p-b-2,.n-p-b-sm { padding-bottom: ${props => props.variables['spacing.2']}; }
...
.n-p-r-6,.n-p-r-lg { padding-right: ${props => props.variables['spacing.6']}; }
.n-p-t-6,.n-p-t-lg { padding-top: ${props => props.variables['spacing.6']}; }
.n-p-b-6,.n-p-b-lg { padding-bottom: ${props => props.variables['spacing.6']}; }
