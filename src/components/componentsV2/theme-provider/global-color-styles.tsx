...
const GlobalColorStyles = createGlobalStyle<{ variables: TVariables }>`
  ...
  .n-color-secondary { color: ${props => props.variables['font.color.secondary']}; }
  ...
  .n-yellow,.n-yellow-6 { color: ${props => props.variables['color.yellow.6']}; }
  ...
  .n-orange,.n-orange-6 { color: ${props => props.variables['color.orange.6']}; }
  ...
  .n-purple,.n-purple-6 { color: ${props => props.variables['color.purple.6']}; }
  ...
  .n-danger-1,.n-error-1 { color: ${props => props.variables['color.error.1']}; }
  .n-danger-2,.n-error-2 { color: ${props => props.variables['color.error.2']}; }
  .n-danger-3,.n-error-3 { color: ${props => props.variables['color.error.3']}; }
  .n-danger-4,.n-error-4 { color: ${props => props.variables['color.error.4']}; }
  .n-danger-5,.n-error-5 { color: ${props => props.variables['color.error.5']}; }
  .n-danger-6,.n-error-6 { color: ${props => props.variables['color.error.6']}; }
  .n-danger-7,.n-error-7 { color: ${props => props.variables['color.error.7']}; }
  .n-danger-8,.n-error-8 { color: ${props => props.variables['color.error.8']}; }
  .n-danger-9,.n-error-9 { color: ${props => props.variables['color.error.9']}; }
  .n-danger-10,.n-error-10 { color: ${props => props.variables['color.error.10']}; }
